...
describe('Table utils - Data transformation', () => {
    ...
    describe('Get table totals with data', () => {
        ...
        it('should return totals ordered by default list when totals are not present ' +
            ...
            execResult.executionResult.headerItems[0][0] = [];
    ...
    describe('ExecutionResult headerItems', () => {
        it('should filter only arrays which contains some attribute header items', () => {
            ...
            const extendedExecutionResultWithMeasureHeaderItems = set(
                EXECUTION_RESULT_1A,
                'headerItems[1]',
                EXECUTION_RESULT_1A.executionResult.headerItems[1].concat([measureHeaderItems])
    ...
    describe('Backward compatible table headers and table rows for drilling', () => {
        it('should get backward compatible header for attribute', () => {
            expect(getBackwardCompatibleHeaderForDrilling(
