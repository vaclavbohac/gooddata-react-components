...
const WrappedTable: any = withIntl(ResponsiveTable); // TODO any

const getMore = (wrapper: any) => wrapper.find('.s-show_more'); // TODO any
const getLess = (wrapper: any) => wrapper.find('.s-show_less'); // TODO any
...
describe('Responsive Table', () => {
    ...
    function renderTable(tableData: ITableData, customProps: object = {}):
    ...
    describe('proportions', () => {
        ...
        it('should compute table max height using data and total rows count', () => {
            ...
            const componentInstance: any = wrapper.find(ResponsiveTable).instance(); // TODO any
    ...
    describe('when data contains more than 1 page of rows', () => {
        ...
        describe('and table is showing some page', () => {
            ...
            it('should set correct number of rows', () => {
                const wrapper: ReactWrapper<IResponsiveTableProps, IResponsiveTableState> = prepareComponent();
                expect(wrapper.find(Table).prop('rows').length).toEqual(ROWS_PER_PAGE * 2); // TODO
            });

            it('should return to first page when user clicks "Less"', () => {
                const wrapper: ReactWrapper<IResponsiveTableProps, IResponsiveTableState> = prepareComponent();
                getLess(wrapper).simulate('click');
                expect(wrapper.find(Table).prop('rows').length).toEqual(ROWS_PER_PAGE); // TODO
            });
        ...
        describe('and table is showing last page', () => {
            ...
            it('should set correct number of rows', () => {
                const wrapper: ReactWrapper<IResponsiveTableProps, IResponsiveTableState> = prepareComponent();
                expect(wrapper.find(Table).prop('rows').length).toEqual(25); // TODO
            });
