...
import { TableHeader, IAttributeTableHeader, IMeasureTableHeader } from '../../interfaces/data';
import 'jest';
...
describe('Totals', () => {
    ...
    describe('getTotalsDataSource', () => {
        const usedTotals: ITotalWithData[] = [
            createTotalItem('sum'),
            createTotalItem('max')
        ];
    ...
    describe('resetRowClass', () => {
        ...
        it('should keep given classname if row on the given column index already has one', () => {
            ...
            resetRowClass(
                rowReference, testClassname, '.indigo-totals-remove > .indigo-totals-remove-row', columnIndex
            );
    ...
    describe('removeTotalsRow', () => {
        ...
        it('should return totals without selected total', () => {
            ...
            expect(removeTotalsRow(usedTotals, totalToRemove)).toEqual([
                sum
            ]);
        });
    ...
    describe('shouldShowAddTotalButton', () => {
        ...
        it('should return true if column is not first, is of \'measure\' type and adding of more totals is enabled', () => {
            ...
            expect(shouldShowAddTotalButton(measureHeader, isFirstColumn, addingMoreTotalsEnabled)).toEqual(true);
        });
        ...
        it('should return false if column is first, is not of \'measure\' type or adding of more totals is not enabled', () => {
            ...
            const addingMoreTotalsEnabled = true;
            expect(shouldShowAddTotalButton(measureHeader, isFirstColumn, addingMoreTotalsEnabled)).toEqual(false);
            expect(shouldShowAddTotalButton(measureHeader, !isFirstColumn, !addingMoreTotalsEnabled)).toEqual(false);
    ...
    describe('getTotalsDefinition', () => {
        const totals: ITotalWithData[] = [
            createTotalItem('sum', [], [1]),
            createTotalItem('avg', [], [2])
        ];
