...
export type IBaseChartDataPromise = Promise<Execution.AfmExecutionResponse>;
...
export class BaseChart extends React.Component<IBaseChartProps, IBaseChartState> {
    ...
    constructor(props: IBaseChartProps) {
        ...
        this.subscription = this.subject
            .switchMap<IBaseChartDataPromise, Execution.AfmExecutionResponse>(identity)
            .subscribe((result: Execution.AfmExecutionResponse) => {
                this.setState({
                    result
                });
