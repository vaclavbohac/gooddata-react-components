...
function createDataSource(result: Execution.AfmExecutionResponse, afm: AFM.IAfm = {}) {
...
describe('BaseChart', () => {
    ...
    it('should call onError with DATA_TOO_LARGE_TO_COMPUTE', () => {
        const onError = jest.fn();
        const tooLargeDataSource = createDataSource(tooLargeResponse, afm);
        const props = createProps({
            onError,
    ...
    it('should call onError with BAD_REQUEST', () => {
        const onError = jest.fn();
        const badRequestDataSource = createDataSource(badRequestResponse, afm);
        const props = createProps({
            onError,
